...
var bitmexSocket = new BitMEXClient({testnet: true, apiKeyID: process.env.BITMEX_TEST_KEY, apiKeySecret: process.env.BITMEX_TEST_SECRET});
...
.then(function(client) {
  ...
  client.clientAuthorizations.add("apiKey", new BitMEXAPIKeyAuthorization(process.env.BITMEX_TEST_KEY, process.env.BITMEX_TEST_SECRET));
  api = client;
})
.catch(function(e){
  console.log(e);
